...
public class AdminController {
	...
	@PostMapping
	@Operation(description="Add new Course Details")
	public ResponseEntity<?> addNewCourse(@RequestBody AddCourseDTO requestDTO){
		return ResponseEntity.status(HttpStatus.CREATED)
				.body(courseService.addCourse(requestDTO));
	}
